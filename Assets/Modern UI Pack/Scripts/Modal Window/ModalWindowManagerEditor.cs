...
namespace Michsky.MUIP
{
    ...
    public class ModalWindowManagerEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            try
            {
                tempUIM = mwTarget.GetComponent<UIManagerModalWindow>();
            }
            catch { }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 2:
                    ...
                    closeOnCancel.boolValue =
                        MUIPEditorHandler.DrawToggle(closeOnCancel.boolValue, customSkin, "Close Window On Cancel");
                    closeOnConfirm.boolValue = MUIPEditorHandler.DrawToggle(closeOnConfirm.boolValue, customSkin,
                        "Close Window On Confirm");
                    showCancelButton.boolValue =
                        MUIPEditorHandler.DrawToggle(showCancelButton.boolValue, customSkin, "Show Cancel Button");
                    showConfirmButton.boolValue = MUIPEditorHandler.DrawToggle(showConfirmButton.boolValue, customSkin,
                        "Show Confirm Button");
                    ...
                    if (tempUIM != null)
                    {
                        ...
                        if (GUILayout.Button("Disable UI Manager Connection", customSkin.button))
                            if (EditorUtility.DisplayDialog("Modern UI Pack",
                                ...
                                {
                                    Debug.LogError("<b>[Modal Window]</b> Failed to delete UI Manager connection.",
                                        this);
                                }
                    }
