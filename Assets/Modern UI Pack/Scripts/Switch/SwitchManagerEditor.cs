...
namespace Michsky.MUIP
{
    ...
    public class SwitchManagerEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            try
            {
                tempUIM = switchTarget.GetComponent<UIManagerSwitch>();
            }
            catch { }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (enableSwitchSounds.boolValue && useHoverSound.boolValue)
                        MUIPEditorHandler.DrawProperty(hoverSound, customSkin, "Hover Sound");

                    if (enableSwitchSounds.boolValue && useClickSound.boolValue)
                ...
                case 1:
                    ...
                    GUILayout.Space(-3);
                    enableSwitchSounds.boolValue = MUIPEditorHandler.DrawTogglePlain(enableSwitchSounds.boolValue,
                        customSkin, "Enable Switch Sounds");
                    GUILayout.Space(3);
                    ...
                    GUILayout.Space(-3);
                    saveValue.boolValue =
                        MUIPEditorHandler.DrawTogglePlain(saveValue.boolValue, customSkin, "Save Value");
                    GUILayout.Space(3);
