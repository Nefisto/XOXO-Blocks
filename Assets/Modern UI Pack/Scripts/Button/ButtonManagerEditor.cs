...
namespace Michsky.MUIP
{
    ...
    public class ButtonManagerEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            try
            {
                tempUIM = buttonTarget.GetComponent<UIManagerButton>();
            }
            catch { }
        ...
        public override void OnInspectorGUI()
        {
            ...
            buttonTarget.latestTabIndex =
                MUIPEditorHandler.DrawTabs(buttonTarget.latestTabIndex, toolbarTabs, customSkin);
            ...
            switch (buttonTarget.latestTabIndex)
            {
                case 0:
                    ...
                    if (useCustomContent.boolValue == false)
                    {
                        ...
                        enableIcon.boolValue =
                            MUIPEditorHandler.DrawTogglePlain(enableIcon.boolValue, customSkin, "Enable Icon");
                        ...
                        enableText.boolValue =
                            MUIPEditorHandler.DrawTogglePlain(enableText.boolValue, customSkin, "Enable Text");
                    ...
                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);
                    autoFitContent.boolValue =
                        MUIPEditorHandler.DrawTogglePlain(autoFitContent.boolValue, customSkin, "Auto-Fit Content");
                    GUILayout.Space(4);
                    ...
                    if (Application.isPlaying && GUILayout.Button("Refresh", customSkin.button))
                        buttonTarget.UpdateUI();
                ...
                case 2:
                    ...
                    isInteractable.boolValue =
                        MUIPEditorHandler.DrawToggle(isInteractable.boolValue, customSkin, "Is Interactable");
                    if (useCustomContent.boolValue || enableText.boolValue == false)
                        GUI.enabled = false;
                    useCustomTextSize.boolValue = MUIPEditorHandler.DrawToggle(useCustomTextSize.boolValue, customSkin,
                        "Use Custom Text Size");
                    GUI.enabled = true;
                    useCustomContent.boolValue =
                        MUIPEditorHandler.DrawToggle(useCustomContent.boolValue, customSkin, "Use Custom Content");
                    checkForDoubleClick.boolValue = MUIPEditorHandler.DrawToggle(checkForDoubleClick.boolValue,
                        customSkin, "Check For Double Click");

                    GUILayout.BeginVertical(EditorStyles.helpBox);
                    GUILayout.Space(-3);

                    useUINavigation.boolValue =
                        MUIPEditorHandler.DrawTogglePlain(useUINavigation.boolValue, customSkin, "Use UI Navigation");
                    ...
                    if (useUINavigation.boolValue)
                    {
                        ...
                        if (buttonTarget.navigationMode == Navigation.Mode.Horizontal)
                        {
                            ...
                            wrapAround.boolValue =
                                MUIPEditorHandler.DrawToggle(wrapAround.boolValue, customSkin, "Wrap Around");
                            //  GUILayout.Space(4);
                            EditorGUI.indentLevel = 0;
                        }
                        ...
                        {
                            wrapAround.boolValue =
                                MUIPEditorHandler.DrawTogglePlain(wrapAround.boolValue, customSkin, "Wrap Around");
                        }
                    ...
                    enableButtonSounds.boolValue = MUIPEditorHandler.DrawTogglePlain(enableButtonSounds.boolValue,
                        customSkin, "Enable Button Sounds");
                    ...
                    if (enableButtonSounds.boolValue)
                    {
                        ...
                        useHoverSound.boolValue = MUIPEditorHandler.DrawToggle(useHoverSound.boolValue, customSkin,
                            "Enable Hover Sound");
                        useClickSound.boolValue = MUIPEditorHandler.DrawToggle(useClickSound.boolValue, customSkin,
                            "Enable Click Sound");
                    ...
                    useRipple.boolValue =
                        MUIPEditorHandler.DrawTogglePlain(useRipple.boolValue, customSkin, "Use Ripple");

                    GUILayout.Space(4);

                    if (useRipple.boolValue)
                    {
                        renderOnTop.boolValue =
                            MUIPEditorHandler.DrawToggle(renderOnTop.boolValue, customSkin, "Render On Top");
                    ...
                    if (tempUIM != null)
                    {
                        ...
                        if (GUILayout.Button("Disable UI Manager Connection", customSkin.button))
                            if (EditorUtility.DisplayDialog("Modern UI Pack",
                                ...
                                {
                                    Debug.LogError(
                                        "<b>[Horizontal Selector]</b> Failed to delete UI Manager connection.", this);
                                }
                    }

                    else if (tempUIM == null)
                    {
                        if (buttonTarget.isPreset)
                        {
                        ...
                        else
                        {
                            ...
                            {
                                var uimb = buttonTarget.gameObject.AddComponent<UIManagerButton>();
