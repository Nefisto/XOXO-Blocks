...
namespace Michsky.MUIP
{
    public class DemoListShadow : MonoBehaviour, IBeginDragHandler
    {
        ...
        [Header("Settings")]
        [SerializeField]
        private float scrollTime = 5;

        [SerializeField]
        private float transitionSpeed = 4;
        ...
        {
            StopCoroutine("ScrollUpHelper");
            StopCoroutine("ScrollDownHelper");
        }
        ...
        {
            StopCoroutine("ScrollDownHelper");
            StartCoroutine("ScrollUpHelper");
        }

        public void ScrollDown()
        {
            StopCoroutine("ScrollUpHelper");
            StartCoroutine("ScrollDownHelper");
        }
