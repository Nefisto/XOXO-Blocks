...
namespace Michsky.MUIP
{
    ...
    public class TooltipManagerEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            try
            {
                tempUIM = tooltipTarget.GetComponent<UIManagerTooltip>();
            }
            catch { }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (tooltipTarget.tooltipObject != null
                    ...
                    EditorGUILayout.HelpBox(
                        "In order to use the tooltip system, you should add the 'Tooltip Content' component to your objects.",
                        MessageType.Info);
                    break;
                ...
                case 2:
                    ...
                    checkDispose.boolValue =
                        MUIPEditorHandler.DrawToggle(checkDispose.boolValue, customSkin, "Check Dispose/Null");
