...
namespace Michsky.MUIP
{
        ...
        IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void UpdateUI()
        {
            ...
            {
                var normalizedAngle = SliderAngle / 360.0f;
        ...
        private bool HasValueChanged() => SliderAngle != currentAngleOnPointerDown;
        ...
        private void HandleSliderMouseInput (PointerEventData eventData, bool allowValueWrap)
        {
            ...
            Vector2 localPos;
            RectTransformUtility.ScreenPointToLocalPointInRectangle(hitRectTransform, eventData.position,
            ...
            if (!allowValueWrap)
            {
                ...
                var needsClamping = Mathf.Abs(newAngle - currentAngle) >= 180;
