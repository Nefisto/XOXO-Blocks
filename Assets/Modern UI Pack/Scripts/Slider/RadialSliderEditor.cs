...
namespace Michsky.MUIP
{
    ...
    public class RadialSliderEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            try
            {
                tempUIM = rsTarget.GetComponent<UIManagerSlider>();
            }
            catch { }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    currentValue.floatValue =
                        EditorGUILayout.Slider(currentValue.floatValue, rsTarget.minValue, rsTarget.maxValue);
                ...
                case 2:
                    ...
                    rememberValue.boolValue =
                        MUIPEditorHandler.DrawToggle(rememberValue.boolValue, customSkin, "Save Value");

                    if (rememberValue.boolValue)
                    {
            ...
            if (rsTarget.sliderImage != null && rsTarget.indicatorPivot != null && rsTarget.valueText != null)
            {
                ...
                var normalizedAngle = rsTarget.SliderAngle / 360.0f;
                ...
                rsTarget.valueText.text =
                    string.Format("{0}{1}", currentValue.floatValue, rsTarget.isPercent ? "%" : "");
            }
