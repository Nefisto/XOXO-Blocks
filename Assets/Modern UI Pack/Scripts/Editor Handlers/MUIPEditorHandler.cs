    ...
    public class MUIPEditorHandler : Editor
    {
        ...
        public static void DrawUIManagerConnectedHeader()
        {
            EditorGUILayout.HelpBox(
                "This object is connected with the UI Manager. Some parameters (such as colors, "
        ...
        {
            EditorGUILayout.HelpBox(
                "This object is subject to a custom preset and cannot be used with the UI Manager. "
