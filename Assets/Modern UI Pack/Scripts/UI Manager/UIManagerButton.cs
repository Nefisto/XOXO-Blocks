...
namespace Michsky.MUIP
{
    ...
    public class UIManagerButton : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (UIManagerAsset == null || buttonManager == null)
                return;
        ...
        private void UpdateButton()
        {
            if (overrideColors == false)
            {
                if (disabledBackground != null)
                    disabledBackground.color = highlightedBackground.color =
                        new Color(UIManagerAsset.buttonAccentColor.r, UIManagerAsset.buttonAccentColor.g,
                            UIManagerAsset.buttonAccentColor.b, UIManagerAsset.buttonDisabledAlpha);
            ...
            if (buttonManager.enableIcon && overrideColors == false)
            {
                ...
                {
                    if (disabledIcon != null)
                        disabledIcon.color = new Color(UIManagerAsset.buttonAccentColor.r,
                            UIManagerAsset.buttonAccentColor.g, UIManagerAsset.buttonAccentColor.b,
                            UIManagerAsset.buttonDisabledAlpha);
                    if (normalIcon != null)
            ...
            if (buttonManager.enableText)
            {
                if (overrideColors == false)
                {
                    ...
                    {
                        if (disabledText != null)
                            disabledText.color = new Color(UIManagerAsset.buttonAccentColor.r,
                                UIManagerAsset.buttonAccentColor.g, UIManagerAsset.buttonAccentColor.b,
                                UIManagerAsset.buttonDisabledAlpha);
                        if (normalText != null)
