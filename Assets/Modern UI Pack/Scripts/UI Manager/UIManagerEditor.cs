    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            if (customSkin == null)
            {
                EditorGUILayout.HelpBox(
                    "Editor variables are missing. You can manually fix this by deleting "
            ...
            showAnimatedIcon =
                GUILayout.Toggle(showAnimatedIcon, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
            ...
            showHorSelector =
                GUILayout.Toggle(showHorSelector, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
            GUILayout.EndHorizontal();
            GUILayout.Space(foldoutBottomSpace);
            ...
            showInputField =
                GUILayout.Toggle(showInputField, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
            GUILayout.EndHorizontal();
            GUILayout.Space(foldoutBottomSpace);
            ...
            showModalWindow =
                GUILayout.Toggle(showModalWindow, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
            GUILayout.EndHorizontal();
            GUILayout.Space(foldoutBottomSpace);
            ...
            showNotification =
                GUILayout.Toggle(showNotification, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
            GUILayout.EndHorizontal();
            GUILayout.Space(foldoutBottomSpace);
            ...
            if (showNotification)
            {
                ...
                EditorGUILayout.LabelField(new GUIContent("Title Font"), customSkin.FindStyle("Text"),
                    GUILayout.Width(120));
                ...
                GUILayout.EndHorizontal();
                GUILayout.BeginHorizontal(EditorStyles.helpBox);
                EditorGUILayout.LabelField(new GUIContent("Description Font"), customSkin.FindStyle("Text"),
                    GUILayout.Width(120));
            ...
            showProgressBar =
                GUILayout.Toggle(showProgressBar, new GUIContent(""), customSkin.FindStyle("Toggle Helper"));
            GUILayout.EndHorizontal();
            GUILayout.Space(foldoutBottomSpace);
            ...
            showCustomObjects = GUILayout.Toggle(showCustomObjects, new GUIContent(""),
            ...
            GUILayout.BeginVertical(EditorStyles.helpBox);
            GUILayout.Space(-3);
            editorHints.boolValue =
                MUIPEditorHandler.DrawTogglePlain(editorHints.boolValue, customSkin, "UI Manager Hints");
            GUILayout.Space(3);

            if (editorHints.boolValue)
            {
                EditorGUILayout.HelpBox(
                    "These values are universal and affect all objects containing 'UI Manager' component.",
                    MessageType.Info);
                EditorGUILayout.HelpBox(
                    "If want to assign unique values, remove 'UI Manager' component from the object ",
                    MessageType.Info);
                EditorGUILayout.HelpBox("You can press 'Control/Command + Shift + M' to open the manager quickly.",
                    MessageType.Info);
            }
        ...
        private void ResetToDefaults()
        {
            if (EditorUtility.DisplayDialog("Reset to defaults",
                ...
                try
                {
                    var defaultPreset = Resources.Load<Preset>("UI Manager Presets/Default");
