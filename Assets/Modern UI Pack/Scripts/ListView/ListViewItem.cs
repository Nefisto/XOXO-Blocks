    ...
    public class ListViewItem : MonoBehaviour
    {
        ...
        public void PassReferences()
        {
            ...
            if (row0Ref.rowType == ListView.RowType.Icon)
            {
                ...
                row0.iconImage.transform.localScale =
                    new Vector3(row0Ref.iconScale, row0Ref.iconScale, row0Ref.iconScale);
            }
            ...
            if (row0Ref.usePreferredWidth)
                row0.layoutElement.preferredWidth = row0Ref.preferredWidth;
            else
                row0.layoutElement.preferredWidth = -1;
            ...
            if (row1Ref.rowType == ListView.RowType.Icon)
            {
                ...
                row1.iconImage.transform.localScale =
                    new Vector3(row1Ref.iconScale, row1Ref.iconScale, row1Ref.iconScale);
            }
            ...
            if (row1Ref.usePreferredWidth)
                row1.layoutElement.preferredWidth = row1Ref.preferredWidth;
            else
                row1.layoutElement.preferredWidth = -1;
            ...
            if (row2Ref.rowType == ListView.RowType.Icon)
            {
                ...
                row2.iconImage.transform.localScale =
                    new Vector3(row2Ref.iconScale, row2Ref.iconScale, row2Ref.iconScale);
            }
            ...
            if (row2Ref.usePreferredWidth)
                row2.layoutElement.preferredWidth = row2Ref.preferredWidth;
            else
                row2.layoutElement.preferredWidth = -1;
        }
    }
}