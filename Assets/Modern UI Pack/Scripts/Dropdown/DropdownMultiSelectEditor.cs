                ...
                case 2:
                    ...
                    if (enableTrigger.boolValue && dTarget.triggerObject == null)
                    {
                        ...
                        EditorGUILayout.HelpBox(
                            "'Trigger Object' is not assigned. Go to Resources tab and assign the correct variable.",
                            MessageType.Error);
                        GUILayout.EndHorizontal();
                    }
                    ...
                    isListItem.boolValue =
                        MUIPEditorHandler.DrawTogglePlain(isListItem.boolValue, customSkin, "Is List Item");

                    GUILayout.Space(3);

                    if (isListItem.boolValue)
                    {
                        ...
                        if (dTarget.listParent == null)
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox(
                                "'List Parent' is not assigned. Go to Resources tab and assign the correct variable.",
                                MessageType.Error);
                            GUILayout.EndHorizontal();
                        }
                    }
