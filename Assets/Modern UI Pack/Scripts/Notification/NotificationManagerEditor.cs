...
namespace Michsky.MUIP
{
    ...
    public class NotificationManagerEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            try
            {
                tempUIM = ntfTarget.GetComponent<UIManagerNotification>();
            }
            catch { }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    else
                    {
                        if (ntfTarget.iconObj == null)
                        {
                            ...
                            EditorGUILayout.HelpBox(
                                "'Icon Object' is not assigned. Go to Resources tab and assign the correct variable.",
                                MessageType.Error);
                            GUILayout.EndHorizontal();
                        }
                    }
                    ...
                    else
                    {
                        if (ntfTarget.titleObj == null)
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox(
                                "'Title Object' is not assigned. Go to Resources tab and assign the correct variable.",
                                MessageType.Error);
                            GUILayout.EndHorizontal();
                        }
                    }
                    ...
                    EditorGUILayout.LabelField(new GUIContent("Description"), customSkin.FindStyle("Text"),
                        GUILayout.Width(-3));
                    ...
                    else
                    {
                        if (ntfTarget.descriptionObj == null)
                        {
                            GUILayout.BeginHorizontal();
                            EditorGUILayout.HelpBox(
                                "'Description Object' is not assigned. Go to Resources tab and assign the correct variable.",
                                MessageType.Error);
                            GUILayout.EndHorizontal();
                        }
                    }
                ...
                case 2:
                    ...
                    closeOnClick.boolValue =
                        MUIPEditorHandler.DrawToggle(closeOnClick.boolValue, customSkin, "Close On Click");
                    useStacking.boolValue =
                        MUIPEditorHandler.DrawToggle(useStacking.boolValue, customSkin, "Use Stacking");
                    enableTimer.boolValue =
                        MUIPEditorHandler.DrawToggle(enableTimer.boolValue, customSkin, "Enable Timer");
                    ...
                    if (tempUIM != null)
                    {
                        ...
                        if (GUILayout.Button("Disable UI Manager Connection", customSkin.button))
                            if (EditorUtility.DisplayDialog("Modern UI Pack",
                                ...
                                {
                                    Debug.LogError(
                                        "<b>[Notification Manager]</b> Failed to delete UI Manager connection.", this);
                                }
                    }
