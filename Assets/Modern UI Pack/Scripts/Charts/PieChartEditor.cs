...
namespace Michsky.MUIP
{
    ...
    public class PieChartEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            try
            {
                tempUIM = pieTarget.GetComponent<UIManagerPieChart>();
            }
            catch { }
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (pieTarget.gameObject.activeInHierarchy)
                ...
                case 1:
                    ...
                    addValueToIndicator.boolValue = MUIPEditorHandler.DrawToggle(addValueToIndicator.boolValue,
                        customSkin, "Add Value To Indicator");

                    if (addValueToIndicator.boolValue)
                    {
                    ...
                    enableBorderColor.boolValue = MUIPEditorHandler.DrawToggle(enableBorderColor.boolValue, customSkin,
                        "Enable Border Color (Experimental)");

                    if (enableBorderColor.boolValue)
                    ...
                    if (tempUIM != null)
                    {
                        ...
                        if (GUILayout.Button("Disable UI Manager Connection", customSkin.button))
                            if (EditorUtility.DisplayDialog("Modern UI Pack",
                                ...
                                {
                                    Debug.LogError("<b>[Pie Chart]</b> Failed to delete UI Manager connection.", this);
                                }
                    }
