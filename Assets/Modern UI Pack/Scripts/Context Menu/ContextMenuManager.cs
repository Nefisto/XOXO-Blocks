    ...
    public class ContextMenuManager : MonoBehaviour
    {
        ...
        public void SetContextMenuPosition()
        {
            ...
            if (mainCanvas.renderMode == RenderMode.ScreenSpaceCamera || mainCanvas.renderMode == RenderMode.WorldSpace)
            {
                ...
                contextContent.transform.localPosition = Vector3.SmoothDamp(contextContent.transform.localPosition,
                    contentPos, ref contextVelocity, 0);
            }

            else if (mainCanvas.renderMode == RenderMode.ScreenSpaceOverlay)
            {
                contextRect.position = cursorPos;
                contextContent.transform.position =
                    new Vector3(cursorPos.x + contentPos.x, cursorPos.y + contentPos.y, 0);
            }
        ...
        {
            Debug.Log("<b>[Context Menu]</b> UI Pos: " + uiPos + ", H: " + horizontalBound + ", V: " + verticalBound,
                this);
        }
